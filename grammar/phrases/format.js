    ...
    seq(
      ...
      repeat(
        choice(
          ...
          seq($._kw_list_item_pairs, field("pairs", $.__format_radio_set_buttons)),
          // oxlint-disable-next-line tree-sitter-optimize/shared-sequence
    ...
    prec.right(
      seq(
        ...
        choice(
          ...
          seq($._kw_fill_in, optional(kw("NATIVE")), optional($.__format_view_as_tail)),
