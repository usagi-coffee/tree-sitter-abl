...
- `docs/abl-contents.txt`: index of reference entries
...
- Retrieve syntax information from the language reference
  ...
  - Example: `bun run reference 'DEFINE VARIABLE'`: Return details for the define variable statement
  - Example: `bun run reference 'operator'`: Returns all sections related to operators
