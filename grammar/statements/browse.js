module.exports = ({ kw, tkw }) => ({
  ...
  __browse_option: ($) =>
    choice(
      ...
      alias($.__browse_no_column_scrolling_option, $.no_column_scrolling_option),
      ...
      alias($.__browse_scrollbar_horizontal_option, $.scrollbar_horizontal_option),
  ...
  __browse_column_label_option: ($) => seq(tkw("COLUMN-LABEL"), $.string_literal),
  __browse_column_dcolor_option: ($) => seq(tkw("COLUMN-DCOLOR"), $._expression),
  __browse_column_bgcolor_option: ($) => seq(tkw("COLUMN-BGCOLOR"), $._expression),
  __browse_column_fgcolor_option: ($) => seq(tkw("COLUMN-FGCOLOR"), $._expression),
  __browse_column_pfcolor_option: ($) => seq(tkw("COLUMN-PFCOLOR"), $._expression),
  ...
  __browse_context_help_id_option: ($) => seq(tkw("CONTEXT-HELP-ID"), $._expression),
  ...
  __browse_down_option: ($) => seq(kw("DOWN"), optional($._expression)),
  ...
  __browse_max_data_guess_option: ($) => seq(tkw("MAX-DATA-GUESS"), $._expression),
  ...
  __browse_size_option: ($) => seq(kw("SIZE"), $._expression, kw("BY"), $._expression),
